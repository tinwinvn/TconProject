            ...
            <div class="table-data">               
                <div id="chartBox" class="chartBox">               
                    ...
                    <form id="fetchForm" action="../ChartServlet" method="GET">
                        <button id="fetchButton" type="submit" class="btn btn-primary" style="color: white; background-color: #C60000; padding: 2px 4px; border: none; border-radius: 4px; transition: all 0.3s ease;">Xem số liệu</button>                        </form>
                ...
                <div id="chartBox2" class="chartBox">               
                    ...
                    <form id="fetchForm2" action="../ChartServlet" method="GET">
                        <button id="fetchButton" type="submit" class="btn btn-primary" style="color: white; background-color: #3366CC; padding: 2px 4px; border: none; border-radius: 4px; transition: all 0.3s ease;">Xem số liệu</button>
                    </form>
                    <label for="weekPicker">Chọn tuần:</label>
                ...
                <div id="chartBox3" class="chartBox">               
                    ...
                    <form id="fetchForm3" action="../ChartServlet" method="GET">
                        <button id="fetchButton" type="submit" class="btn btn-primary" style="color: white; background-color: #FFD700; padding: 2px 4px; border: none; border-radius: 4px; transition: all 0.3s ease;">Xem số liệu</button>                        </form>
                    <label for="weekPicker">Chọn tuần:</label>
                ...
                <div id="chartBox4" class="chartBox">               
                    ...
                    <form id="fetchForm4" action="../ChartServlet" method="GET">
                        <button id="fetchButton" type="submit" class="btn btn-primary" style="color: white; background-color: #33CCFF; padding: 2px 4px; border: none; border-radius: 4px; transition: all 0.3s ease;">Xem số liệu</button>                        </form>
                    <label for="weekPicker">Chọn tuần:</label>
